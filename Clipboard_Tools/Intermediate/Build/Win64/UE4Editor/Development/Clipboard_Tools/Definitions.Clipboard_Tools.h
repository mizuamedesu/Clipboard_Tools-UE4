...
#define UE_PROJECT_NAME ASCII
#define UE_TARGET_NAME ASCIIEditor
#define UE_MODULE_NAME "Clipboard_Tools"
#define UE_PLUGIN_NAME "Clipboard_Tools"
...
#define CLIPBOARD_TOOLS_API DLLEXPORT
